...
const Gallery = () => {
  ...
  const galleryImages = [
    {
      id: 1,
      src: 'https://images.unsplash.com/photo-1621605815971-fbc98d665033?w=600&h=800&fit=crop&crop=center',
      alt: 'Classic gentleman haircut',
      category: 'Haircuts'
    },
    {
      id: 2,
      src: 'https://images.unsplash.com/photo-1599351431202-1e0f0137899a?w=600&h=800&fit=crop&crop=center',
    ...
    {
      id: 5,
      src: 'https://images.unsplash.com/photo-1582095133179-bfd08e2fc6b3?w=600&h=800&fit=crop&crop=center',
      alt: 'Precision beard styling',
      category: 'Beard Work'
    },
    {
      id: 6,
      src: 'https://images.unsplash.com/photo-1606402179428-a57976d71fa4?w=600&h=800&fit=crop&crop=center',
      alt: 'Classic pompadour',
      category: 'Haircuts'
    },
    {
      id: 7,
      src: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=600&h=600&fit=crop&crop=center',
      alt: 'Vintage barber tools',
      category: 'Shop'
    },
    {
      id: 8,
      src: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=600&h=800&fit=crop&crop=center',
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mt-20 animate-fade-in-up">
            ...
            <p className="text-lg text-barbershop-gray-600 mb-8 max-w-lg mx-auto">
              Book your appointment today and experience the precision that sets us apart.
            </p>
            <a
              href="/booking"
